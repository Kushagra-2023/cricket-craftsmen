...
export const TeamSelector = ({ teams, selectedTeams, onTeamSelect, maxSelections }: TeamSelectorProps) => {
  const isTeamSelected = (team: Team) => selectedTeams.some(t => t.id === team.id);
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">{team.players.length} players available</p>
                  </div>
                </div>
