...
//   onSelect?: (player: Player) => void;
//   positionColor?: string;
//   swapMode?: boolean;          // new
//   selectedPlayer?: Player | null; // new
// }
...
//     // Conditional URL
//     const url = swapMode && selectedPlayer
//       ? `http://127.0.0.1:8000/players/compare?out=${encodeURIComponent(selectedPlayer.name)}&in=${encodeURIComponent(player.name)}`
//       : `http://127.0.0.1:8000/players/summary/${encodeURIComponent(player.name)}`;
...
export const PlayerCard = ({
  ...
  //     // 🔥 Use different URL if in swap mode
  //     const url =
  //       swapMode && selectedPlayer
  //         ? `http://127.0.0.1:8000/players/comparison?out=${encodeURIComponent(
  //             selectedPlayer.name
  //           )}&in=${encodeURIComponent(player.name)}`
  //         : `http://127.0.0.1:8000/players/summary/${encodeURIComponent(
  //             player.name
  //           )}`;
